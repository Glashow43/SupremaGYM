...
function renderExPicker() {
  ...
  exs.forEach(function(e, i) {
    ...
    var thumb = e.image
      ? '<div class="ex-pick-icon" style="padding:0;overflow:hidden;"><img src="' + e.image + '" style="width:100%;height:100%;object-fit:cover;border-radius:10px;" onerror="this.remove()"></div>'
...
function renderExPage() {
  ...
  for (var ci = 0; ci < orderedCats.length; ci++) {
    ...
    for (var gi = 0; gi < groups[cat].length; gi++) {
      ...
      var d = e.desc || '';
      var thumb = e.image
        ? '<div class="exrow-thumb" style="padding:0;overflow:hidden;"><img src="' + e.image + '" style="width:100%;height:100%;object-fit:cover;border-radius:9px;" onerror="this.remove()"></div>'
